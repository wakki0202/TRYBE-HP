      ...
      <main className='font-body bg-gray-100'>
        <div className='w-10/12 lg:w-8/12 m-auto'>
          <div className='text-center pt-20 w-full'>
            <h1 className='text-2xl lg:text-5xl font-black pb-6'>Creative Director</h1>
            <Image src={`/AnyConv.com__ken.webp`} width={1300} height={750} alt="" className='' />

          </div>
          <div className='lg:flex lg:pb-20 pb-14 pt-3'>
            ...
            <div className='lg:w-8/12'>
              ...
              <p className='hidden lg:block text-xs  leading-relaxed pb-6 font-bold'>Email：k_yamamoto@trybe.co.jp</p>
          ...
          <div className='text-center pb-20 text-sm lg:text-xl font-bold'>
            <Link href={"/members/hinata"} ><a >＜ BACK</a></Link>　|　<Link href={"/members"}><a>BACK TO LIST</a></Link>　|　<Link href={"/members/sota"}><a>NEXT ＞</a></Link>
          </div>
        </div>
      </main>
