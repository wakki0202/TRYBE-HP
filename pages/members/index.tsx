  ...
  const members = [
    {
      ...
      twitter: "https://twitter.com/hinata_1215_",
      instagram:"https://www.instagram.com/h_ntiaa/"
    },
    {
      id: 2,
      name: "山本健太",
      ...
      twitter: "https://twitter.com/Buffowwky",
      instagram: "https://www.instagram.com/kenta.y.m/"
    },
    {
      id: 3,
      name: "稲田創太",
      ...
      introduction: "2000年生まれ。株式会社TRYBE取締役。 イラスト、デザイン、写真、映像などのクリエイティブ業務の企画から編集まで一貫して行うディレクター。またエンタメ事業全体のディレクション、その他事業の企画立案、バックオフィス業務なども手がけ、枠やジャンルに収まらない役割を担う。学生が運営している他の組織・団体・法人との接点となり、マネージャーとしての役割も担っている。",
      ...
      twitter: "https://twitter.com/inaaady1003",
      instagram: "https://www.instagram.com/iinaady/"
    },
    {
      id: 4,
      name: "戸澤愛梨",
      ...
      twitter: "https://twitter.com/jr_tozawa",
      instagram: "https://www.instagram.com/jr_tozawa/"
    },
    {
    id: 5,
      name: "松下峻輔",
      ...
      twitter: "https://twitter.com/chiken2583",
      instagram: "https://www.instagram.com/sm.chiken888/"
    },
    {
      id: 6,
      name: "井上友聖",
      ...
      twitter: "https://twitter.com/yuseinemui",
      instagram: "https://www.instagram.com/yusei.0401/"
    },
    {
      id: 7,
      name: "南湧太",
      ...
      twitter: "",
      instagram: "https://www.instagram.com/no_camera_cameraman_yuta/"
    },
    {
      id: 8,
      name: "辻本太郎",
      ...
      twitter: "",
      instagram: "https://www.instagram.com/taroveller/"
    },
    {
      id: 9,
      name: "藤本樹林",
      ...
      twitter: "https://twitter.com/jurin_j",
      instagram:"https://www.instagram.com/jurin_jj/"
    },
    // {
    //   id: 10,
    //   name: "今泉大輝",
    ...
    // },
    {
      ...
      twitter: "",
      instagram: "https://www.instagram.com/haruhata2340/"
    },
    {
      id: 12,
      name: "森脇弓貴",
      ...
      twitter: "",
      instagram: "https://www.instagram.com/0202waki/"
    },
    {
      id: 13,
      name: "中島秀時",
      ...
      twitter: "",
      instagram: "https://www.instagram.com/hide_1204/"
    },
    {
      id: 14,
      name: "河内壱成",
      ...
      twitter: "https://twitter.com/dpfkp825",
      instagram: "https://www.instagram.com/dpfkp1/"
    },
    {
      id: 15,
      name: "今泉大輝",
      ...
      position: "プランナー",
      image: "taiki.gif",
      introduction: "2000年生まれ。SNSマーケティングを中心にマーケターとして成長を続ける一面もあれば、大学と連携したイベントの企画や絵本制作、ポスター制作の企画なども行う。自身の原体験から、心身に特性をもつ人にサービスを届けるという目標を持ち、その目標を目指し日々成長を続ける。",
      achievement: "Instagramを利用した小説制作のプランニング。関西大学とkokoima主催のファッションショーの運営や服の作成やポスター制作。",
      tel: "080-6927-4020",
      email: "Email：t_imaizumi@trybe.co.jp",
      twitter: "",
      instagram: "https://www.instagram.com/_izuminn_1230/"
    }]
