    ...
    <div className='w-8/12 m-auto'>
      ...
      <div className='flex pt-24'>
        <div className=' w-2/12 '>
          <h1 className=' text-2xl font-bold text-gray-400'>Issue</h1>
        </div>
        <div className=' w-10/12'>
          <h1 className='text-xl font-bold pb-2'>高校の休み時間が、スマートフォンに奪われる</h1>
      ...
      <div className='flex pt-24'>
        <div className=' w-2/12 '>
          <h1 className=' text-2xl font-bold text-gray-400'>Solution</h1>
        </div>
        <div className=' w-10/12'>
          <h1 className='text-xl font-bold pb-2'>休み時間の10分で出来る、 人狼ボードゲーム</h1>
      ...
      <div className='flex pt-24'>
        ...
        <div className=' w-10/12'>
          <h1 className='text-xl font-bold pb-2'>活気を取り戻す休み時間</h1>
          ...
          <h1 className='text-xl font-bold pb-2 pt-7'>若者の圧倒的支持によりクラウドファンディング達成</h1>
      ...
      <div className='flex pt-24 pb-32 list-none'>
        ...
        <div className='w-3/12 list-none ml-10'>
